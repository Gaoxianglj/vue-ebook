...
import { SaveLocation, SaveSetting } from '@/api/store'
...
export function setBookObject (fileName, key, value) {
  ...
  switch (key) {
    case 'fontFamily': SaveSetting(fileName, value, null, null).catch(setLocalStorage(`${fileName}-NE`, 'ture')); break
    case 'fontSize': SaveSetting(fileName, null, value, null); break
    case 'location': SaveLocation(fileName, value, null); break
    case 'readTime': SaveLocation(fileName, null, value); break
    case 'bookmark': SaveSetting(fileName, null, null, value); break
  }
}
// 获取图书信息
